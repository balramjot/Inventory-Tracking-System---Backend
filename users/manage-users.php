...
<?php include '../view/afterloginHeader.php';?> 
    <div class="container cont_cls">
            <h2><center>Manage User</center></h2>
...
?>
            ...
            <td><?php echo $i; ?></td>
              ...
              <td><?php echo $user->getDateTime(); ?></td>
              <td>
              <?php
                if($user->getStatus() == 1)
                {
              ?>
                <form method="POST" action="index.php">
                  ...
                  <input type="hidden" name="stat_id" value="<?php echo $user->getID(); ?>"/>
              ...
              <td>
                <a href="?action=edit&edit_id=<?php echo $user->getID(); ?>" class="btn btn-xs btn-info" style="padding: 1px 15px;">Edit</a>
                <a href="?action=delete&del_id=<?php echo $user->getID(); ?>" class="btn btn-xs btn-danger" style="padding: 1px 15px;" onclick="return confirm('Are you sure you want to delete this record ? This action cannot be undone. Continue ?')">Delete</a>
              </td>
...
<?php
  ...
  {
      echo "<tr colspan='7'><td>No user added yet !!!</td></tr>";
  }
?>
          </tbody>
        </table>
